## Objective
- Let gpt know about area information, so [execute_services](https://github.com/jekalmin/llm-homeassistant/tree/v1.0.2/examples/function/area#execute_services) can be called using `area_id`
