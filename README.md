...
## Installation
1. Install via registering as a custom repository of llm-homeassistant or by copying `extended_openai_conversation` folder into `<config directory>/custom_components`
